    ...
    <>
      ...
      <section className="Services-section" id="services">
        ...
        <p className="visoion-text fade_up">
          My vision is to be a trailblazing force in the world of web design
        ...
        <div className="row services-row">
          ...
          <div className="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6 services-column fade_up">
            <Link to="#services-popup">
              ...
              <p className="services-text services-text3">React DEVELOPMENT</p>
              <p className="molestie">
                I provide quality full service by using react js. 
              </p>
              <img
          ...
          <div className="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6 services-column fade_up">
            <Link to="#services-popup">
              ...
              <p className="services-text services-text4">Frontend DEVELOPMENT</p>
              <p className="molestie">
                Frontend developemt is one of the core thing for web development . It make a website super smote and faster.
              </p>
              <img
                className="down-arrow-svg"
                src={DownArrow}
